...
namespace PlatformaBrowaru.Data.Migrations
{
    ...
    [Migration("20180427185617_Fixed Typo in Review Model")]
    partial class FixedTypoinReviewModel
    {
            ...
            modelBuilder.Entity("PlatformaBrowaru.Share.Models.Brand", b =>
                {
                    ...
                    b.Property<long?>("BrandProductionId");
                    ...
                    b.HasIndex("BrandProductionId")
                        .IsUnique()
                        .HasFilter("[BrandProductionId] IS NOT NULL");
            ...
            modelBuilder.Entity("PlatformaBrowaru.Share.Models.Brand", b =>
                {
                    ...
                    b.HasOne("PlatformaBrowaru.Share.Models.BrandProduction", "BrandProduction")
                        .WithOne("Brand")
                        .HasForeignKey("PlatformaBrowaru.Share.Models.Brand", "BrandProductionId");
